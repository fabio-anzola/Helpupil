...
router.route('/approve/:documentId').patch(auth('manageDocs'), validate(moderatorValidation.edit), documentController.approve);
router.route('/decline/:documentId').patch(auth('manageDocs'), validate(moderatorValidation.edit), documentController.decline);
