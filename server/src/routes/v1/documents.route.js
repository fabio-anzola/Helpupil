 ...
 *     description: Only logged in users can retrieve documents.
 *     tags: [Documents]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *         schema:
 *           type: boolean
 *         description: Define if search is sensitive
 *       - in: query
 *         name: searchstring
 *         schema:
 *           type: string
 ...
 *         schema:
 *           type: boolean
 *         description: Search for exactly the searchstring
 *       - in: query
 *         name: inverse
 *         schema:
 *           type: boolean
 *         description: Inverse the search
 *       - in: query
 *         name: sortBy
 *         schema:
 *           type: string
